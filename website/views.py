...
def create_post():
	if request.method == 'POST':
		...
		if not text:
			flash('Post cannotbe empty', category='error')
		else:
...
def delete_post(id):
	...
	elif current_user.id != post.user.id and current_user.legend is False:
...
def profile(username):
	#implement current_user details> query to username
